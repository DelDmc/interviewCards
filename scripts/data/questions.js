...
=======
  ...
  },
  {
    ...
    subquestions: [
      {
        text: `Can you describe the main difference between the Array.forEach() loop
               and Array.map() methods and why you would pick one versus the other?`,
        status: 'NOK',
      },
    ],
  },
  ...
  {
    text: `What are some of the advantages/disadvantages of writing 
  ...
  },
  {
    ...
    subquestions: [
      {
        text: 'Can you pxamof a higher-order function in JavaScript?',
        status: 'NOK',
      },
      {
        text: 'What are some of the benefits of using higher-order functions in your code?',
