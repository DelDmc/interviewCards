export const questions = [
  ...
  },
  {
    ...
    subquestions: [
      {
        text: `Can you describe the main difference between the Array.forEach() 
               loop and Array.map() methods and why you would pick one versus the other?`,
        status: false,
      },
    ],
  },
  ...
  {
    text: `What are some of the advantages/disadvantages of 
           writing JavaScript code in a language that compiles to JavaScript?`,
    status: false,
    subquestions: [],
  },
  {
  ...
  {
    text: `Can you offer a use case for the new arrow => function syntax? 
